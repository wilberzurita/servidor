...
<form id="form1" name="form1" method="post" action="frmCategoria.php">
  <table width="400" border="0">
    <tr> <td> </td>
     <td>
     <input name="txtIdCategoria" type="hidden" value="<? echo $_GET['pid_categoria']; ?>" id="txtIdCategoria" />
     </td>
    </tr>
	...
	<tr>
      ...
      <td width="225">	 	  
        <input name="txtNombre" type="text"  value="<? echo $_GET['pnombre']; ?>" id="txtNombre" />
      </td>
    </tr>
